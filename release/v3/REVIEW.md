# MiniHarnessCode v3 review pack

## Project pitch

MiniHarnessCode is a small local coding agent that turns one user request into a bounded
...
- The `Pico` runtime class owns session state, memory, tools, and workspace safety.
