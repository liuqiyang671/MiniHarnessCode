# MiniHarnessCode v3 testing

The v3 acceptance package is a real-use scenario suite, not a unit-test index.
It drives MiniHarnessCode through CLI, REPL, slash command, resume, provider profile,
skills, worker, memory, and artifact flows, then verifies the files MiniHarnessCode wrote.
